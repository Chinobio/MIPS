...
def IF(instruction):
    ...
    global currentInstructionNum,cycle,write_to_file
    ...
    print('IF stage ',rawInstructions[currentInstructionNum].split(" ")[0])
    write_to_file.append(rawInstructions[currentInstructionNum].split(" ")[0] + " : IF")
...
def ID(instruction:Instruction):
    global currentInstructionNum,cycle, flag,write_to_file
    next_stage = "EX"
    ...
    write_to_file.append(PipelineRegister.IF_ID['output'].rawInstruction.split(" ")[0] + " : ID")
    isBranch = False
...
def EX(instruction:Instruction):
    global cycle,currentInstructionNum,write_to_file
    if instruction == None:
    ...
    write_to_file.append(PipelineRegister.ID_EX['output'].rawInstruction.split(" ")[0] + " : EX " + PipelineRegister.ID_EX['output'].signal['EX'] + " " + PipelineRegister.ID_EX['output'].signal["M"] + " " + PipelineRegister.ID_EX['output'].signal["WB"])
...
def MEM(instruction:Instruction):
    ...
    write_to_file.append(PipelineRegister.EX_MEM['output'].rawInstruction.split(" ")[0] + " : MEM " + PipelineRegister.EX_MEM['output'].signal['M'] + " " + PipelineRegister.EX_MEM['output'].signal["WB"])
...
def WB(instruction):
    global cycle,write_to_file
    if instruction == None:
        print("WB stage: None")
        return
    print("WB stage",PipelineRegister.MEM_WB['output'].rawInstruction)
    write_to_file.append(PipelineRegister.MEM_WB['output'].rawInstruction.split(" ")[0] + " : WB " + PipelineRegister.MEM_WB['output'].signal["WB"])
